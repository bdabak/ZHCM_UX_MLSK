		...
		onStartIntro: function(){
			...
			const driverObj = driver({
				...
				steps: [
				  ...
				  { element: "#" + that.byId("idCreateNewSkillButton").$().attr("id"), popover: { title: 'Yeni Beceri', description: 'Beceri havuzuna yeni bir beceri eklemek için burayı kullanabilirsiniz.Eklediğiniz beceriyi istediğiniz sonrasında çalışana ekleyebilirsiniz.', side: "bottom", align: 'center' }},
